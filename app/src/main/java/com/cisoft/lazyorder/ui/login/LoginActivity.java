package com.cisoft.lazyorder.ui.login;
...
import com.cisoft.lazyorder.core.common.CommonService;
...
public class LoginActivity extends BaseActivity {
    ...
    private void obtainAuthCode() {
        ...
        /* 创建一个正在发送短信验证码的提示对话框 */
        final Dialog obtainingTipDialog = DialogFactory.createToastDialog(this, "正在发送短信验证码");
        obtainingTipDialog.setCancelable(false);
        obtainingTipDialog.setCanceledOnTouchOutside(false);
        obtainingTipDialog.show();

        commonService.obtainSMSAuthCode(userMobileNumber, new CommonService.OnSMSCodeSendFinish() {
            @Override
            ...
            public void onFailure(int stateCode) {
                ...
                ViewInject.toast(commonService.getResponseStateInfo(stateCode));
            }
        });
    }
    ...
    private void doSureLogin() {
        ...
        /* 创建一个正在验证的提示对话框 */
        final Dialog verifyingTipDialog = DialogFactory.createToastDialog(this, "正在验证");
        verifyingTipDialog.setCancelable(false);
        verifyingTipDialog.setCanceledOnTouchOutside(false);
        verifyingTipDialog.show();

        commonService.verifyPhoneBySMSAuthCode(userMobileNumber, authCode, new CommonService.OnPhoneVerifyFinish() {
            @Override
            public void onSuccess() {
