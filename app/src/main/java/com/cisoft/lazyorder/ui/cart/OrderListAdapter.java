...
import com.cisoft.lazyorder.widget.AddAndSubNumView;
 ...
 */
public class OrderListAdapter extends BaseAdapter implements View.OnClickListener, AddAndSubNumView.OnOrderNumChangeListener{
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            ...
            viewHolder.onvGoodOrderNum = (AddAndSubNumView) convertView.findViewById(R.id.onvGoodOrderNum);
    ...
    public void onClick(View view) {
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                View parentView = (View) finalView.getParent().getParent();
    ...
    public class ViewHolder{
        ...
        public AddAndSubNumView onvGoodOrderNum;
