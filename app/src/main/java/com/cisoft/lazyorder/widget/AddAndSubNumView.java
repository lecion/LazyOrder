 ...
 */
public class AddAndSubNumView extends FrameLayout{
    ...
    public AddAndSubNumView(Context context) {
        super(context);
    ...
    public AddAndSubNumView(Context context, int num) {
        super(context);
        this.context = context;
        this.num = num;
        LayoutInflater.from(context).inflate(R.layout.order_num_layout, this);
    ...
    public AddAndSubNumView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        LayoutInflater.from(context).inflate(R.layout.order_num_layout, this);
    ...
    private class ButtonOnClickListener implements OnClickListener{
        ...
        public void onClick(View view) {
            ...
            if(changeListener != null) {
                changeListener.onChange(AddAndSubNumView.this, num);
            }
        }
    }
